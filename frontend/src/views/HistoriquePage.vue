<template>
  <div class="background">
    ...
    <div id="container">
      ...
      <!-- Informations sur le fichier publié -->
      <div class="file-info">
        ...
        <!-- Affiche un message si aucun fichier n'est ajouté -->
    ...
    <div v-show="modalVisible" class="modal">
      <div class="modal-content">
        ...
        <div class="dropArea" @dragenter.prevent @dragover.prevent @dragleave.prevent @drop.prevent="handleDrop"
          @click="ouvrirGestionnaireFichiers" accept=".json">
...
export default {
  data() {
    return {
      modalVisible: false, // État de visibilité de la modal
      fichierAjoute: false, // Indique si un fichier est ajouté
      nomFichier: null, // Nom du fichier ajouté
    };
  },
  methods: {
    ouvrirModal() {
...
.modal {
  ...
  width: 40%;
  /* 40% de la largeur de la page */
  height: 40%;
  /* 40% de la hauteur de la page */
  transform: translate(-50%, -50%);
  /* Ajuster le centrage après le dimensionnement */
}
...
#add-file {
  position: absolute;
  top: 20px;
  /* Ajuster la marge par rapport au haut du conteneur */
  right: 20px;
  background-color: #dcb253;
  /* Couleur grise pour le fond */
  border: none;
  cursor: pointer;
  border-radius: 50%;
  /* Rend le bouton rond */
  padding: 15px;
  /* Ajuste la taille du bouton en fonction de vos préférences */
...
#add-file img {
  width: 50px;
  /* Ajuster la taille de l'image en fonction de vos préférences */
}
